...
const DIR_URL = path.resolve(__dirname, '../../src/componentDocs');
const OUTPUT_DIR = path.resolve(__dirname, '../../database');
const OUTPUT_JSON = path.join(OUTPUT_DIR, 'sitemap-database.json');
