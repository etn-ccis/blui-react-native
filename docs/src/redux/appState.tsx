...
import {
  SiteThemePayloadType,
  SiteDirectionPayloadType,
  SiteThemeType,
  UIDirection,
} from '../__types__';
...
const siteDirection = localStorage.getItem(
  'site-direction',
) as null | UIDirection;
...
export const appStateSlice = createSlice({
  ...
  reducers: {
    ...
    changeSiteTheme: (
      state: AppState,
      action: PayloadAction<SiteThemePayloadType>,
    ) => {
    ...
    changeDirection: (
      state: AppState,
      action: PayloadAction<SiteDirectionPayloadType>,
    ) => {
...
export const {closeDrawer, toggleDrawer, changeSiteTheme, changeDirection} =
