...
You can adjust the limitations on the selections with the `limitTags` (sets how many options can be selected) and `limitCharacterCountTag` (limits how many characters can be used in a custom option) props.
