...
## v8.2.0 (March 13, 2026)

### Changed

- Add loading spinner on login screen [176](https://github.com/etn-ccis/blui-react-native/issues/176)


## v8.1.1 (December 18, 2025)

### Fixed

- Login Screen Loader Displays Incorrect Background Colors (80% Grey, 20% Black) [367](https://github.com/etn-ccis/blui-react-native/issues/367)

## v8.1.0 (October 16, 2025)
