...
mkdir -p "./examples/showcase/node_modules/@brightlayer-ui/react-native-auth-workflow/dist"
rm -rf "./examples/workflow/node_modules/@brightlayer-ui/react-native-auth-workflow"
mkdir -p "./examples/workflow/node_modules/@brightlayer-ui/react-native-auth-workflow/dist"
...
cp -r ./packages/auth-workflows/dist/ ./examples/showcase/node_modules/@brightlayer-ui/react-native-auth-workflow/dist
...
cp -r ./packages/auth-workflows/dist/ ./examples/workflow/node_modules/@brightlayer-ui/react-native-auth-workflow/dist
echo -e "${GREEN}Done${NC}"
