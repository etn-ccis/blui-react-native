...
rm -rf "./examples/showcase-expo/node_modules/@brightlayer-ui/react-native-components"
mkdir -p "./examples/showcase-expo/node_modules/@brightlayer-ui/react-native-components/dist"
...
cp -r ./packages/component-library/dist/* ./examples/showcase-expo/node_modules/@brightlayer-ui/react-native-components/
...
#         fi;
# fi
if [ ! -f ./examples/showcase-expo/node_modules/@brightlayer-ui/react-native-components/package.json ]; then echo -e "${BRED}Components Not Linked to expo showcase${NC}" && exit 1; fi
if [ ! -f ./examples/showcase-expo/node_modules/@brightlayer-ui/react-native-components/index.js ]; then echo -e "${BRED}Components Not Linked to expo showcase${NC}" && exit 1; fi
