...
git remote add upstream git@github.com:etn-ccis/blui-react-native.git
...
```sh
origin git@github.com:<your_github_username>/blui-react-native.git (fetch)
origin git@github.com:<your_github_username>/blui-react-native.git (push)
upstream git@github.com:etn-ccis/blui-react-native.git (fetch)
upstream git@github.com:etn-ccis/blui-react-native.git (push)
```
...
Check the [issues list](https://github.com/etn-ccis/blui-react-native/issues) for anything you'd like to work on. If something exists, comment to claim it.

No issue yet? [Create one](https://github.com/etn-ccis/blui-react-native/issues/new/choose). Issues help us track work and streamline the contribution process.
