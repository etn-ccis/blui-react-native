const resources = {
    translation: {
        REGISTRATION: {
            ...
            SUCCESS_MESSAGE: "Votre compte a été créé avec le courrier électronique <boldTag>{{email}}</boldTag>.\n\nVotre compte a déjà été ajouté à l'organisation <boldTag>{{organization}}</boldTag>.",
            SUCCESS_MESSAGE_ALT: "Votre compte a été créé avec le courrier électronique <boldTag>{{email}}</boldTag>.\n\nVotre compte a déjà été ajouté à l'organisation <boldTag>{{organization}}</boldTag>.",
            SUCCESS_MESSAGE_WITHOUT_EMAIL_PROVIDED: "Votre compte à été créé avec succès.\n\nVotre compte a déjà été ajouté à l'organisation <boldTag>{{organization}}</boldTag>.",
            SUCCESS_MESSAGE_ALT_WITHOUT_EMAIL_PROVIDED: "Votre compte à été créé avec succès.\n\nVotre compte a déjà été ajouté à l'organisation <boldTag>{{organization}}</boldTag>.",
            ...
            FAILURE_MESSAGE: "Nous n'avons pas pu terminer votre inscription. Appuyez sur Continuer ci-dessous pour finir.",
