const resources = {
    translation: {
        REGISTRATION: {
            ...
            SUCCESS_MESSAGE: '您已成功使用<boldTag>{{email}}</boldTag>注册了一个新账号。\n\n您的账号已被加入“<boldTag>{{organization}}</boldTag>”。',
            SUCCESS_MESSAGE_ALT: '您已成功使用<boldTag>{{email}}</boldTag>注册了一个新账号。\n\n您的账号已被加入“<boldTag>{{organization}}</boldTag>”。',
            SUCCESS_MESSAGE_WITHOUT_EMAIL_PROVIDED: '您已成功注册了一个新账号。\n\n您的账号已被加入“<boldTag>{{organization}}</boldTag>”。',
            SUCCESS_MESSAGE_ALT_WITHOUT_EMAIL_PROVIDED: '您已成功注册了一个新账号。\n\n您的账号已被加入“<boldTag>{{organization}}</boldTag>”。',
        ...
        SELF_REGISTRATION: {
            ...
            VERIFY_EMAIL: {
                MESSAGE: '已向您的邮箱中发送了一封验证邮件。请点击邮件中的链接，或者在此输入邮件中的验证码。验证邮件在30分钟内有效。',
                RESEND: '重新发送验证邮件',
