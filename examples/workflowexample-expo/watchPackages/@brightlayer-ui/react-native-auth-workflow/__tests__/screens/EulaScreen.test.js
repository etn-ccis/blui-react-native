...
describe('Eula Screen', () => {
    it('Eula Screen renders correctly', () => {
        const rendered = render(_jsx(PaperProvider, { children: _jsx(RegistrationContextProvider, { ...registrationContextProviderProps, children: _jsx(RegistrationWorkflow, { initialScreenIndex: 0, children: _jsx(EulaScreen, {}) }) }) })).toJSON();
        expect(rendered).toBeTruthy();
    });
    it('check if next button is calling onNext function prop', () => {
        const nextfn = jest.fn();
        render(_jsx(PaperProvider, { children: _jsx(RegistrationContextProvider, { ...registrationContextProviderProps, children: _jsx(RegistrationWorkflow, { initialScreenIndex: 0, children: _jsx(EulaScreen, { eulaContent: 'Hello', checkboxLabel: 'check', checkboxProps: { disabled: false }, WorkflowCardActionsProps: {
                            onNext: () => nextfn(),
                            showNext: true,
    ...
    it('check if previos button is calling onPrevious function prop', () => {
        ...
        render(_jsx(PaperProvider, { children: _jsx(RegistrationContextProvider, { ...registrationContextProviderProps, children: _jsx(RegistrationWorkflow, { initialScreenIndex: 0, children: _jsx(EulaScreen, { eulaContent: 'Hello', checkboxLabel: 'I have read and agree to the Terms & Conditions', initialCheckboxValue: true, WorkflowCardActionsProps: {
                            onPrevious: prevFn(),
                            showPrevious: true,
                            previousLabel: 'Back',
                        } }) }) }) }));
    ...
    it('should throw error in eula and clicking refresh button should call loadEula', async () => {
        ...
        const { findByText } = render(_jsx(PaperProvider, { children: _jsx(RegistrationContextProvider, { ...{
                    language: 'en',
