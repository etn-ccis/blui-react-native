...
const renderer = (props = defaultProps) =>
    render(
        _jsx(RegistrationContextProvider, {
            ...
            children: _jsxs(RegistrationWorkflow, {
                ...props,
                children: [_jsx(Text, { children: 'Screen 1' }), _jsx(Text, { children: 'Screen 2' })],
            }),
        })
    );
describe('RegistrationWorkflow', () => {
            ...
            _jsx(RegistrationContextProvider, {
                ...
                children: _jsxs(RegistrationWorkflow, {
                    children: [
                        _jsxs(_Fragment, {
                            children: [
                                _jsx(Text, { children: 'Indexed Screen 1' }),
                                _jsx(Button, {
                                    onPress: () => {
                        ...
                        _jsx(Text, { children: 'Indexed Screen 2' }),
                    ],
                }),
            })
        );
    ...
    it('should set screen data for custom registration workflow in the context', () => {
        const wrapper = ({ children }) =>
            _jsx(PaperProvider, {
                children: _jsx(RegistrationContextProvider, {
                    ...registrationContextProviderProps,
                    children: _jsx(RegistrationWorkflow, { ...defaultProps, children: children }),
                }),
            });
        const { result } = renderHook(() => useRegistrationWorkflowContext(), { wrapper });
        void act(() => {
    ...
    it('should render custom success screen', () => {
        ...
        const { getByTestId, getByText } = render(
            _jsx(PaperProvider, {
                children: _jsx(RegistrationContextProvider, {
                    ...registrationContextProviderProps,
                    children: _jsx(RegistrationWorkflow, { ...props, children: _jsx(CreateAccountScreen, {}) }),
                }),
            })
        );
    ...
    it('should render existing account screen', () => {
        defaultProps.existingAccountSuccessScreen = _jsx(View, {
            children: _jsx(Text, { children: 'Account Exists!!!' }),
        });
        const wrapper = ({ children }) =>
            _jsx(PaperProvider, {
                children: _jsx(RegistrationContextProvider, {
        ...
        render(
            _jsx(PaperProvider, {
                children: _jsx(RegistrationContextProvider, {
                    ...registrationContextProviderProps,
                    children: _jsx(RegistrationWorkflow, {
                        children: _jsx(TextInput, { testID: 'blui-registration-workflow-text-input' }),
                    }),
                }),
            })
        );
    ...
    it('should display single screen', () => {
        render(
            _jsx(PaperProvider, {
                children: _jsx(RegistrationContextProvider, {
                    ...registrationContextProviderProps,
                    children: _jsx(RegistrationWorkflow, { children: _jsx(CreateAccountScreen, {}) }),
                }),
            })
        );
