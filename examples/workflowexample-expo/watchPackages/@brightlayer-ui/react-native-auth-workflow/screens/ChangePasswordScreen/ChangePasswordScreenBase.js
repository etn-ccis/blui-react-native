...
export const ChangePasswordScreenBase = (props) => {
    ...
    SuccessScreen) => (SuccessScreen ? SuccessScreen(_props) : _jsx(SuccessScreenBase, { ..._props }));
    const handleChange = (text) => {
        currentPasswordChange?.(text);
    };
    return showSuccessScreen ? (getSuccessScreen(slotProps?.SuccessScreen ?? {}, slots?.SuccessScreen)) : (_jsxs(WorkflowCard, { ...cardBaseProps, children: [_jsx(WorkflowCardHeader, { ...headerProps }), _jsx(WorkflowCardBody, { ...cardBodyProps, children: _jsx(ErrorManager, { ...errorDisplayConfig, children: _jsx(SetPassword, { ...passwordProps, children: _jsx(PasswordTextField, { testID: "blui-change-password-current-password-text-field", style: [styles.textInput], label: currentPasswordLabel, ...currentPasswordTextInputProps, onChangeText: (text) => {
