...
export const AccountDetailsScreenBase = (props) => {
    ...
    return (_jsxs(WorkflowCard, { ...cardBaseProps, children: [_jsx(WorkflowCardHeader, { ...headerProps }), _jsx(WorkflowCardBody, { ...cardBodyProps, children: _jsxs(ErrorManager, { ...errorDisplayConfig, children: [_jsx(TextInput, { testID: "blui-account-details-first-name", mode: "flat", ref: firstNameRef, label: firstNameLabel, value: firstNameInput, error: shouldValidateFirstName && !isFirstNameValid, ...firstNameTextInputProps, onChangeText: (text) => {
                            ...
                            }, onBlur: () => setShouldValidateFirstName(true) }), shouldValidateFirstName && _jsx(HelperText, { type: "error", children: firstNameError }), _jsx(TextInput, { testID: "blui-account-details-last-name", mode: "flat", ref: lastNameRef, label: lastNameLabel, value: lastNameInput, error: shouldValidateLastName && !isLastNameValid, style: [styles.textInput], ...lastNameTextInputProps, onChangeText: (text) => {
                                ...
                                if (isFirstNameValid && isLastNameValid && actionsProps.canGoNext)
                                    actionsProps.onNext?.();
                            }, onBlur: () => setShouldValidateLastName(true) }), shouldValidateLastName && _jsx(HelperText, { type: "error", children: lastNameError })] }) }), _jsx(WorkflowCardActions, { ...actionsProps, canGoNext: actionsProps.canGoNext && isFirstNameValid && isLastNameValid })] }));
};
