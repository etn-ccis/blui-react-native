...
export const ForgotPasswordScreenBase = (props) => {
    ...
    const {
        emailLabel,
        initialEmailValue,
        emailValidator = (email) => (new RegExp(EMAIL_REGEX).test(email) ? true : 'Please enter a valid email'),
        SuccessScreen,
    ...
    const getSuccessScreen = (_props, _successScreen) =>
        _successScreen ? _successScreen(_props) : _jsx(SuccessScreenBase, { ..._props });
    ...
    return _jsx(_Fragment, {
        children: showSuccessScreen
            ? getSuccessScreen(successScreenProps ?? {}, SuccessScreen)
            : _jsxs(WorkflowCard, {
                  ...cardBaseProps,
                  children: [
                      _jsx(WorkflowCardHeader, { ...headerProps, onIconPress: handleCloseIconPress }),
