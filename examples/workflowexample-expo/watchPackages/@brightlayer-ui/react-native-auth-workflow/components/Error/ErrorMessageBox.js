...
const makeStyles = (theme, props, dismissible) => StyleSheet.create({
    errorMessageBox: {
        width: '100%',
...
export const ErrorMessageBox = (props) => {
    ...
    return (_jsxs(View, { style: [defaultStyles.errorMessageBox, style], children: [dismissible && (
            // @ts-ignore
            _jsx(Icon, { testID: "blui-error-message-box-close-icon", name: 'close', size: 20, 
                // @ts-ignore
                style: [defaultStyles.icon], onPress: () => {
                    onClose();
                } })), _jsxs(View, { children: [_jsx(Text, { style: [defaultStyles.title], variant: "titleMedium", children: title }), _jsx(Text, { style: [defaultStyles.message], variant: "bodyMedium", children: errorMessage })] })] }));
};
