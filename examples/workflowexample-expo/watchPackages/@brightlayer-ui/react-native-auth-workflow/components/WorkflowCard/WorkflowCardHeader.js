...
const makeStyles = (theme, isTablet, backgroundColor, textColor) =>
    StyleSheet.create({
        header: {
            height: 64,
            ...
            !isTablet &&
                _jsx(View, {
                    ...
                    children: _jsx(StatusBar, {
                        barStyle: Color(backgroundColor ?? theme.colors.primaryContainer).isDark()
                            ? 'light-content'
                            : 'dark-content',
                    }),
                }),
            isTablet &&
                _jsx(StatusBar, { barStyle: Color(theme.colors.primary).isDark() ? 'light-content' : 'dark-content' }),
            _jsxs(View, {
                style: [
                ...
                children: [
                    _jsx(TouchableOpacity, {
                        testID: 'blui-workflow-card-header-icon',
                        onPress: onIconPress,
                        children: getIcon(),
                    }),
                    _jsxs(View, {
                        style: defaultStyles.headerContent,
                        children: [
                            _jsx(Text, { variant: 'titleLarge', style: [defaultStyles.headerText], children: title }),
                            subTitle &&
                                _jsx(Text, {
                                    variant: 'bodyMedium',
                                    style: [defaultStyles.headerText],
                                    children: subTitle,
                                }),
                        ],
                    }),
