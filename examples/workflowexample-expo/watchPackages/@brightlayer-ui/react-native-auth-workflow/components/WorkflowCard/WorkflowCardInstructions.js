...
export const WorkflowCardInstructions = (props) => {
    ...
    return instructions ? (_jsxs(_Fragment, { children: [_jsx(View, { style: [styles.container], children: typeof instructions === 'string' ? (_jsx(Text, { variant: "bodyLarge", style: [styles.workflowCardInstructions, style], ...otherProps, children: instructions })) : (instructions) }), divider && _jsx(Divider, { bold: true })] })) : null;
};
