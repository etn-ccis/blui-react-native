...
const headerBgImage = require('../../src/assets/images/topology_40.png');
const eatonLogo = require('../../src/assets/images/eatonLogo.png');
const eatonLogoWhite = require('../../src/assets/images/eatonLogoWhite.png');
