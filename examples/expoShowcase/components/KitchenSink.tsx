          ...
          <View style={{padding: 10}}>
            ...
            <Card style={styles.card}>
                ...
                >
                    ...
                    <View style={{ marginTop: 24 }}>
                        <RadioButton.Group
                            onValueChange={(val: string): void => setRadioButtonAndroidValue(val)}
                ...
                >
                    ...
                    <View style={{ marginTop: 24 }}>
                        <TextInput
                            ...
                            underlineColor={theme.colors.onSurfaceVariant}
                            value={nameInputText}
                            onChangeText={(inputText: string): void => setNameInputText(inputText)}
                            allowFontScaling={!DISABLE_FONT_SCALE}
                            maxFontSizeMultiplier={MAX_FONT_SCALE}
                        />
                        <TextInput
                            ...
                            onChangeText={(inputText: string): void => setEmailInputText(inputText)}
                            allowFontScaling={!DISABLE_FONT_SCALE}
                            maxFontSizeMultiplier={MAX_FONT_SCALE}
                        />
                        <TextInput
                            ...
                            onChangeText={(inputText: string): void => setErrorNameInputText(inputText)}
                            error
                            allowFontScaling={!DISABLE_FONT_SCALE}
                            maxFontSizeMultiplier={MAX_FONT_SCALE}
                        />
                        <TextInput
                            ...
                            onChangeText={(inputText: string): void => setErrorEmailInputText(inputText)}
                            error
                            allowFontScaling={!DISABLE_FONT_SCALE}
                            maxFontSizeMultiplier={MAX_FONT_SCALE}
                        />
