...
const makeStyles = (isTablet, theme) =>
    StyleSheet.create({
...
export const SetPassword = (props) => {
    ...
    const hasConfirmPasswordError = useCallback(
        () => passwordInput.length !== 0 && confirmInput.length !== 0 && confirmInput !== passwordInput,
        ...
        children: [
            ...
            hasConfirmPasswordError() &&
                _jsx(HelperText, {
                    ...
                    style: defaultStyle.errorHelperText,
                    children: passwordNotMatchError ?? t('bluiCommon:FORMS.PASS_MATCH_ERROR'),
                }),
            !hasConfirmPasswordError() &&
                confirmInput !== '' &&
                confirmInput === passwordInput &&
                _jsx(HelperText, {
                    ...
                    children: t('bluiCommon:FORMS.PASS_MATCH'),
                }),
        ],
    });
};
