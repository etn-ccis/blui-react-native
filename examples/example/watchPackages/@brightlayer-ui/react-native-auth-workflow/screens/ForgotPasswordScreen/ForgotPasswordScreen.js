...
export const ForgotPasswordScreen = (props) => {
    ...
    const workflowCardInstructionProps = {
        instructions: description
            ? _jsxs(View, { children: [' ', description(responseTime), ' '] })
            : _jsx(Text, {
                  variant: 'bodyLarge',
                  children: _jsx(Trans, {
                      ...
                      components: {
                          boldTag: _jsx(Bold, { children: responseTime }),
                          tel: _jsx(Link, { children: contactPhone }),
                      },
                  }),
              }),
        ...WorkflowCardInstructionProps,
    ...
    return _jsx(ForgotPasswordScreenBase, {
            ...
            EmptyStateProps: {
                ...
                description: _jsx(Text, {
                    ...
                    children: _jsx(Trans, {
                        ...
                        components: { boldTag: _jsx(Bold, { children: emailInput }) },
                    }),
                }),
            },
            WorkflowCardHeaderProps: {
