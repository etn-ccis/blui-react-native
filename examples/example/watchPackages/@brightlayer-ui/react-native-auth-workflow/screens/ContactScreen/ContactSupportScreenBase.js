        ...
        children: [
            ...
            icon &&
                _jsx(View, {
                    ...
                    children: _jsx(Icon, { source: icon, size: iconSize ?? 24, color: theme.colors.disabled }),
                }),
            _jsxs(WorkflowCardBody, {
                ...cardBodyProps,
                children: [
                    _jsx(Text, { variant: 'bodyLarge', style: { marginBottom: 8 }, children: emailSupportTitle }),
                    _jsx(_Fragment, { children: emailSupportContent?.(contactEmail ?? '') }),
                    _jsx(Text, {
                        variant: 'bodyLarge',
                        style: { marginBottom: 8, marginTop: 32 },
                        children: phoneSupportTitle,
                    }),
                    _jsx(_Fragment, { children: phoneSupportContent?.(contactPhone ?? '') }),
                ],
            }),
