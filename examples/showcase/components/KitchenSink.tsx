...
export const KitchenSink: React.FC = (): JSX.Element => {
  ...
  const [checkboxAndroidOne, setCheckboxAndroidOne] = React.useState<
    'checked' | 'unchecked' | 'indeterminate'
  >('unchecked');
  const [checkboxAndroidTwo, setCheckboxAndroidTwo] = React.useState<
    'checked' | 'unchecked' | 'indeterminate'
  >('checked');
  const [checkboxIOSOne, setCheckboxIOSOne] = React.useState<
    'checked' | 'unchecked' | 'indeterminate'
  >('unchecked');
  const [checkboxIOSTwo, setCheckboxIOSTwo] = React.useState<
    'checked' | 'unchecked' | 'indeterminate'
  >('checked');
  ...
  const [radioButtonAndroidValue, setRadioButtonAndroidValue] =
  ...
  const onChangeHelperTextInputText = (text: string): void =>
    setHelperTextInputText(text);
