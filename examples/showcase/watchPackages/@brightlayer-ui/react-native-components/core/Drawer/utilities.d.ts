 ...
 */
export declare const mergeStyleProp: <T extends unknown>(parentValue: T, childValue: T) => T | undefined;
/**
 ...
 */
export declare const inheritSharedProps: (parent: AllSharedProps, child: AllSharedProps) => AllSharedProps;
/**
 ...
 */
export declare const findChildByType: (children: ReactNode, type: string[]) => React.JSX.Element[];
