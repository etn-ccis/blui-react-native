 ...
 */
/* eslint-disable */
export const mergeStyleProp = (parentValue, childValue) =>
 ...
 */
export const inheritSharedProps = (parent, child) => ({
  activeChevronColor: mergeStyleProp(
    parent.activeChevronColor,
    child.activeChevronColor,
  ),
  activeItemBackgroundColor: mergeStyleProp(
    parent.activeItemBackgroundColor,
    child.activeItemBackgroundColor,
  ),
  activeItemBackgroundShape: mergeStyleProp(
    parent.activeItemBackgroundShape,
    child.activeItemBackgroundShape,
  ),
  activeItemFontColor: mergeStyleProp(
    parent.activeItemFontColor,
    child.activeItemFontColor,
  ),
  activeItemIconColor: mergeStyleProp(
    parent.activeItemIconColor,
    child.activeItemIconColor,
  ),
  ...
  nestedBackgroundColor: mergeStyleProp(
    parent.nestedBackgroundColor,
    child.nestedBackgroundColor,
  ),
