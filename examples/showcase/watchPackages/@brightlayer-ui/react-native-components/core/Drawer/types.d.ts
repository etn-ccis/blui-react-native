...
export declare const SharedStylePropTypes: {
    activeChevronColor: PropTypes.Requireable<string>;
    activeItemBackgroundColor: PropTypes.Requireable<string>;
    activeItemFontColor: PropTypes.Requireable<string>;
    activeItemIconColor: PropTypes.Requireable<string>;
    backgroundColor: PropTypes.Requireable<string>;
    chevronColor: PropTypes.Requireable<string>;
    divider: PropTypes.Requireable<boolean>;
    itemFontColor: PropTypes.Requireable<string>;
    itemIconColor: PropTypes.Requireable<string>;
};
export declare const NavItemSharedStylePropTypes: {
    activeItemBackgroundShape: PropTypes.Requireable<string>;
    chevron: PropTypes.Requireable<boolean>;
    collapseIcon: PropTypes.Requireable<PropTypes.ReactElementLike>;
    expandIcon: PropTypes.Requireable<PropTypes.ReactElementLike>;
    hidePadding: PropTypes.Requireable<boolean>;
    disableActiveItemParentStyles: PropTypes.Requireable<boolean>;
    nestedBackgroundColor: PropTypes.Requireable<string>;
    nestedDivider: PropTypes.Requireable<boolean>;
};
