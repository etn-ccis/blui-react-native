...
const listItemTagStyles = (props, theme, fontScale, fontSize, fontStyleBold) =>
  StyleSheet.create({
    root: {
      backgroundColor:
        props.backgroundColor || theme.colors.primaryFilledContainer,
...
export const ListItemTag = props => {
  ...
  const defaultStyles = listItemTagStyles(
    props,
    theme,
    fontScale,
    props.fontSize || 10,
