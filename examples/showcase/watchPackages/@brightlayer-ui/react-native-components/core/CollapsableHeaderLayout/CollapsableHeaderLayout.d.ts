...
import { Animated, ViewProps, ScrollViewProps as RNScrollViewProps, StyleProp, ViewStyle } from 'react-native';
...
export type CollapsibleLayoutProps = ViewProps & {
    ...
    ScrollComponent?: (handleScroll: (e: any) => void, contentPadding: Animated.Value, contentOffset: {
        x: number;
        y: number;
    }) => React.JSX.Element;
