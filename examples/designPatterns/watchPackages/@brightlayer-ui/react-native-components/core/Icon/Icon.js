...
export const Icon = props => {
  ...
  if (typeof source === 'object' && isIconFamily(source)) {
    const scale =
      source.allowFontScaling === undefined
        ? allowFontScaling
        : source.allowFontScaling;
    const flip =
      (source.direction === 'auto' && deviceDirection === 'rtl') ||
      source.direction === 'rtl';
    switch (source.family) {
      case 'material-community':
        return React.createElement(MatCommunity, {
          name: source.name,
          size: size,
      ...
      case 'brightlayer-ui':
        return React.createElement(BLUIIcon, {
          name: source.name,
          size: size,
          allowFontScaling: scale,
          color: color,
      ...
      case 'material':
      default:
        return React.createElement(MatIcon, {
          name: source.name,
          size: size,
          allowFontScaling: scale,
          color: color,
