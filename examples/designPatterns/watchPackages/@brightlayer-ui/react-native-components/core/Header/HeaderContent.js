...
const HeaderSubtitle = props => {
  ...
  if (subtitle) {
    return typeof subtitle === 'string'
      ...
      : React.createElement(React.Fragment, null, subtitle);
  }
  return null;
};
/**
...
const HeaderInfo = props => {
  ...
  if (info) {
    return typeof info === 'string'
      ...
      : React.createElement(React.Fragment, null, info);
  }
  return null;
};
/**
...
export const HeaderContent = props => {
  ...
  if (searchConfig && searching) {
    ...
    content = [
      ...
      React.createElement(HeaderSubtitle, {
        subtitle: subtitle,
        key: 'subtitle_key',
        theme: theme,
  ...
  const getActionPanelWidth = useCallback(() => {
    ...
    return (
      iconLength * (ICON_SIZE * fontScale + ICON_SPACING) + componentsWidth
    );
  ...
  return React.createElement(
    ...
    React.createElement(
      View,
      {style: {flex: 0, flexBasis: 'auto', justifyContent: 'center'}},
      content,
    ),
  );
};
