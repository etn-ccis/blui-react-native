...
const HeroPanel = props => {
  ...
  if (badge) {
    return React.createElement(
      View,
      {style: [{flex: 0, flexBasis: 'auto', marginTop: badgeOffset}, style]},
      badge,
    );
  }
  return null;
};
const actionPanelStyles = fontScale =>
  StyleSheet.create({
    root: {
      flexDirection: 'row',
      margin: -8 * fontScale,
...
const scoreCardStyles = (theme, props, fontScale) =>
  StyleSheet.create({
    root: {
      flex: 1,
...
export const ScoreCard = props => {
  ...
  return (
    ...
    React.createElement(
      ...
      React.createElement(
        View,
        {style: [defaultStyles.body, styles.body]},
        React.createElement(
          View,
          {style: [defaultStyles.leftContent, styles.leftContent]},
          children,
        ),
        React.createElement(HeroPanel, {
          badge: badge,
