...
export const InfoListItem = props => {
  ...
  const defaultStyles = infoListItemStyles(
    props,
    theme,
    fontScale,
    fontStyleSemiBold,
  ...
  const getIcon = useCallback(() => {
    if (icon) {
      return React.createElement(
        ...
        {
          style: avatar
            ? [defaultStyles.avatar, styles.avatar]
            : [defaultStyles.icon, styles.icon],
        },
  ...
  const getInfo = useCallback(() => {
    ...
    const renderableInfoParts = infoParts.map(element =>
      renderableInfoComponent(
        element,
        Object.assign({}, defaultStyles.info, styles.info),
        wrapInfo,
      ),
    );
  ...
  const getRightComponent = useCallback(
    () =>
      React.createElement(
        ...
        chevron &&
          React.createElement(MatCommunityIcon, {
            name: 'chevron-right',
            size: 24,
            color: chevronColor,
  ...
  return React.createElement(
    ...
    React.createElement(View, {
      style: [defaultStyles.statusStripe, styles.statusStripe],
    }),
    icon || !hidePadding
      ? React.createElement(
          View,
          {style: [defaultStyles.iconWrapper, styles.iconWrapper]},
          getIcon(),
        )
      : null,
    leftComponent,
    React.createElement(
      View,
      {style: [defaultStyles.mainContent, styles.mainContent]},
      React.createElement(
        Text,
        {
          variant: 'titleMedium',
      ...
      React.createElement(
        View,
        {style: [defaultStyles.subtitleWrapper, styles.subtitleWrapper]},
        getSubtitle(),
      ),
      React.createElement(
        View,
        {style: [defaultStyles.infoWrapper, styles.infoWrapper]},
        getInfo(),
      ),
    ),
    getRightComponent(),
