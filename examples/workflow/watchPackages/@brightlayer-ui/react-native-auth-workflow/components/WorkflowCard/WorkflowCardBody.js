    ...
    return _jsx(_Fragment, {
        children: scrollable
            ? _jsxs(KeyboardAwareScrollView, {
                  ...
                  extraScrollHeight: Platform.OS === 'ios' ? -windowHeight * 0.07 : 0,
                  children: [
                      _jsx(WorkflowCardInstructions, { ...WorkflowCardInstructionProps }),
                      _jsx(Card.Content, {
                          style: [defaultStyles.workflowBody, style],
            ...
            : _jsxs(_Fragment, {
                  children: [
                      ...
                      _jsx(Card.Content, {
                          style: [defaultStyles.workflowBody, style],
                          ...otherCardContentProps,
                          children: _jsx(View, { style: defaultStyles.viewContainer, children: children }),
                      }),
                  ],
              }),
    });
