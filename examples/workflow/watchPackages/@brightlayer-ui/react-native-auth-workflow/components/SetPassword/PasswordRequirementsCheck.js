...
export const PasswordRequirementsCheck = ({ isChecked, label }) => {
    ...
    return (_jsxs(View, { style: { flexDirection: 'row', alignItems: 'center', marginTop: 4 }, children: [_jsx(Icon, { source: { name: 'check' }, color: isChecked ? theme.colors.primary : theme.colors.disabled }), _jsx(Text, { variant: "bodySmall", style: defaultStyle.label, children: label })] }));
};
