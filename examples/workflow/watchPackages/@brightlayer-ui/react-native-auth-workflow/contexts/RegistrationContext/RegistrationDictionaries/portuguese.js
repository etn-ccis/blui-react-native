    ...
    translation: {
        REGISTRATION: {
            ...
            INSTRUCTIONS: {
                ...
                PASSWORD_INFO: 'Por favor selecione uma palavra-passe. Certifique-se de que sua senha atenda aos requisitos de complexidade necessários descritos abaixo.',
            },
            SUCCESS_MESSAGE: 'A sua conta foi criada corretamente com o e-mail <boldTag>{{email}}</boldTag>.\n\nA sua conta já foi adicionada à organização <boldTag>{{organization}}</boldTag>.',
            SUCCESS_MESSAGE_ALT: 'A sua conta foi criada corretamente com o e-mail <boldTag>{{email}}</boldTag>.\n\nA sua conta já foi adicionada à organização <boldTag>{{organization}}</boldTag>.',
            SUCCESS_MESSAGE_WITHOUT_EMAIL_PROVIDED: 'A Sua conta foi criada com sucesso.\n\nA sua conta já foi adicionada à organização <boldTag>{{organization}}</boldTag>.',
            SUCCESS_MESSAGE_ALT_WITHOUT_EMAIL_PROVIDED: 'A Sua conta foi criada com sucesso.\n\nA sua conta já foi adicionada à organização <boldTag>{{organization}}</boldTag>.',
            SUCCESS_EXISTING: 'A sua conta foi criada corretamente. Por favor inicie sessão com o e-mail e palavra-passe da sua conta Eaton.',
        ...
        SELF_REGISTRATION: {
            ...
            VERIFY_EMAIL: {
                MESSAGE: 'Foi enviado um código de verificação para o e-mail que indicou. Clique no link ou preencha o campo com o código para continuar. Este código é válido durante 30 minutos.',
