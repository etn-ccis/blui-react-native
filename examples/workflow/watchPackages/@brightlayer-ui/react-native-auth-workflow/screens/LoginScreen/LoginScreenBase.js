...
export const LoginScreenBase = (props) => {
    ...
    return (_jsx(WorkflowCard, { testID: "blui-login-workflow-card", ...otherProps, children: _jsxs(WorkflowCardBody, { children: [header, _jsx(View, { style: defaultStyles.projectImageWrapper, testID: "blui-login-project-image-wrapper", children: projectImage }), _jsx(ErrorManager, { ...errorDisplayConfig, children: _jsxs(View, { style: defaultStyles.inputFieldsWrapper, testID: "blui-login-input-fields-wrapper", children: [_jsxs(View, { style: defaultStyles.usernameWrapper, children: [_jsx(TextInput, { testID: 'blui-login-username-text-field', label: usernameLabel ?? 'Username', value: username, error: shouldValidateUsername && !isUsernameValid, autoCapitalize: "none", mode: "flat", ...usernameTextFieldProps, onChangeText: (e) => {
                                        ...
                                        } }), shouldValidateUsername && !isUsernameValid && (_jsx(HelperText, { type: "error", children: usernameError }))] }), _jsxs(View, { style: defaultStyles.passwordWrapper, children: [_jsx(PasswordTextField, { testID: 'blui-login-password-text-field', ref: passwordField, onChangeText: (e) => {
                                        ...
                                        } }), shouldValidatePassword && !isPasswordValid && (_jsx(HelperText, { type: "error", children: passwordError }))] })] }) }), _jsxs(View, { style: defaultStyles.rememberMeLoginRowWrapper, testID: 'blui-login-remember-me-row-wrapper', children: [showRememberMe && (_jsxs(View, { style: defaultStyles.rememberMeWrapper, testID: 'blui-login-remember-me-wrapper', children: [_jsx(Checkbox.Android, { status: rememberMe ? 'checked' : 'unchecked', onPress: () => handleRememberMeChanged(!rememberMe), testID: 'blui-login-remember-me-checkbox' }), _jsx(Text, { variant: "bodyLarge", testID: 'blui-login-remember-me-login', style: defaultStyles.rememberMeText, children: rememberMeLabel ?? 'Remember Me' })] })), _jsx(View, { style: [
                                defaultStyles.loginButtonWrapper,
                                {
                                    width: showRememberMe ? 'auto' : '100%',
                                },
                            ], testID: 'blui-login-login-button-wrapper', children: _jsx(Button, { testID: 'blui-login-login-button', onPress: handleLogin, disabled: !isFormValid(), mode: "contained", style: defaultStyles.loginButton, children: loginButtonLabel ?? 'Log In' }) })] }), showForgotPassword && (_jsx(View, { style: defaultStyles.forgotPasswordWrapper, testID: 'blui-login-forgot-password-wrapper', children: _jsx(Text, { variant: "labelLarge", style: { color: theme.colors.primary }, onPress: handleForgotPassword, testID: 'blui-login-forgot-password-label', children: forgotPasswordLabel ?? 'Forgot your password?' }) })), showSelfRegistration && (_jsxs(View, { style: defaultStyles.selfRegisterWrapper, testID: 'blui-login-self-register-wrapper', children: [_jsx(Text, { variant: "bodyMedium", testID: 'blui-login-self-register-instruction-label', children: selfRegisterInstructions ?? 'Need an account?' }), _jsx(Text, { variant: "labelLarge", style: { color: theme.colors.primary }, onPress: handleSelfRegister, testID: 'blui-login-self-register-label', children: selfRegisterButtonLabel ?? 'Register now!' })] })), showContactSupport && (_jsx(View, { style: defaultStyles.contactSupportWrapper, testID: 'blui-login-contact-support-wrapper', children: _jsx(Text, { variant: "labelLarge", style: { color: theme.colors.primary }, onPress: handleContactSupport, testID: 'blui-login-contact-support-label', children: contactSupportLabel ?? 'Contact Support' }) })), _jsx(View, { style: defaultStyles.footerWrapper, children: footer }), showCyberSecurityBadge && (_jsx(View, { style: defaultStyles.cyberSecurityBadgeWrapper, testID: 'blui-login-cyber-security-badge-wrapper', children: _jsx(Image
                    //@ts-ignore
                    , { 
                        //@ts-ignore
                        style: { ...cyberSecurityBadgeSize }, resizeMode: "contain", source: require('../../assets/images/cybersecurity_certified.png') }) }))] }) }));
};
