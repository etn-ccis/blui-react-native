...
describe('WorkflowCardHeader', () => {
    ...
    it('WorkflowCardHeader renders correctly', () => {
        const rendered = render(
            _jsx(SafeAreaProvider, { children: _jsx(WorkflowCardHeader, { title: 'title', onIconPress: jest.fn() }) })
        ).toJSON();
    ...
    it('WorkflowCardHeader renders correctly with custom icon', () => {
        const rendered = render(
            _jsx(SafeAreaProvider, {
                children: _jsx(WorkflowCardHeader, {
                    title: 'title',
                    backgroundColor: '#fff',
                    onIconPress: jest.fn(),
                    icon: { name: 'close' },
    ...
    it('renders the title and subtitle correctly', () => {
        ...
        const { getByText } = render(
            _jsxs(SafeAreaProvider, {
                children: [' ', _jsx(WorkflowCardHeader, { title: title, subTitle: subtitle, onIconPress: jest.fn() })],
            })
        );
    ...
    it('calls onIconPress when the icon is pressed', () => {
        ...
        const { getByTestId } = render(
            _jsx(SafeAreaProvider, {
                children: _jsx(WorkflowCardHeader, { title: 'Test Title', onIconPress: onIconPress }),
            })
        );
