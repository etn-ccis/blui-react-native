...
describe('WorkflowCardActions Test', () => {
    ...
    it('renders the nextLabel correctly', () => {
        ...
        const { getByText } = render(
            _jsx(WorkflowCardActions, { nextLabel: nextLabel, previousLabel: 'Previous', showNext: true })
        );
    ...
    it('renders the previousLabel correctly', () => {
        ...
        const { getByText } = render(
            _jsx(WorkflowCardActions, { previousLabel: previousLabel, nextLabel: 'Next', showPrevious: true })
        );
