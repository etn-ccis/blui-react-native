...
describe('ErrorContextProvider', () => {
    it('should render ErrorContextProviderProvider without crashing', () => {
        render(_jsx(ErrorContextProvider, { ...errorContextProviderProps, children: _jsx(Text, { children: "Error" }) })).toJSON();
        expect(render).toBeTruthy();
        expect(screen.getByText('Error')).toBeTruthy();
    });
    it('should read values from the context', () => {
        const wrapper = ({ children }) => (_jsx(ErrorContextProvider, { ...errorContextProviderProps, children: children }));
        const { result } = renderHook(() => useErrorContext(), { wrapper });
        expect(result.current.mode).toBe('dialog');
    });
    it('should set values in the context', () => {
        const wrapper = ({ children }) => (_jsx(ErrorContextProvider, { ...errorContextProviderProps, mode: "message-box", children: children }));
        const { result } = renderHook(() => useErrorContext(), { wrapper });
    ...
    it('should set the prop values in the context', () => {
        const wrapper = ({ children }) => (_jsx(ErrorContextProvider, { ...errorContextProviderProps, mode: "dialog", children: children }));
        const { result } = renderHook(() => useErrorManager(), { wrapper });
    ...
    it('should set the custom values in the context', () => {
        const wrapper = ({ children }) => (_jsx(ErrorContextProvider, { ...errorContextProviderProps, title: "Custom Title", children: children }));
        const { result } = renderHook(() => useErrorManager(), { wrapper });
