...
describe('ContactSupportScreenBase tests', () => {
    ...
    it('renders without crashing', () => {
        render(
            _jsx(PaperProvider, {
                children: _jsx(ContactSupportScreenBase, {
                    WorkflowCardHeaderProps: { title: 'Test Contact Us' },
                    icon: _jsx(Icon, { size: 24, source: 'contacts' }),
                    ...
                    emailSupportContent: (contactEmail) =>
                        _jsxs(Text, {
                            children: [
                                ...
                                _jsx(Text, { children: contactEmail }),
                                `.`,
                            ],
                        }),
                    phoneSupportContent: (phone) =>
                        _jsxs(Text, {
                            children: ['For technical support, please call ', _jsx(Text, { children: phone }), `.`],
                        }),
